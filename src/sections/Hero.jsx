...
const Hero = () => {
  return (
    <section className='flex flex-col justify-center items-center gap-5 w-3/4 h-screen'>
        ...
        <p className='text-foreground-muted text-xl'>I solve problems through Software and Engineering </p>
